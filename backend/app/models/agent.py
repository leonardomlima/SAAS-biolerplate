...
class Agent(SQLModel, table=True):
    ...
    )  # "reasoning", "creative", "coding", "fast"
    ...
    sessions: List["ChatSession"] = Relationship(back_populates="agent")
...
class ChatSession(SQLModel, table=True):
    ...
    # "metadata" é reservado na API Declarative do SQLAlchemy, por isso o
    # atributo é "session_metadata" e a coluna fica com o nome "metadata".
...
class ToolDefinition(SQLModel, table=True):
    ...
    )  # "productivity", "web", "data", "automation"
